...
#   plot-vcfstats sample.chr21.filtered.rare.recode.vcf.stats -p sample-chr21-vcfplots/
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. SRR69 .. SRR6914927.chr21.filtered.rare.recode.vcf
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='SRR69')
    has_data = 1
